...
<section class="content404">
	<div class="row">
		<div class="small-12 medium-10 medium-centered large-7 columns text-center">
			<img src="<?php echo $image; ?>" alt="<?php _e( "Error 404", THB_THEME_NAME ); ?>" class="animation fade-in"/>
			<h3 class="animation fade-in"><?php _e( "WE COULDN'T FIND THE PAGE<br> YOU ARE LOOKING FOR.", THB_THEME_NAME ); ?></h3>
		</div>
  </div>
</section>
<?php get_footer(); ?>