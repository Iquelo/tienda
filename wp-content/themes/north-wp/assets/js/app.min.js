        ...
        carousel: {
            ...
            init: function() {
                ...
                container.each(function() {
                    ...
                    that.data("autowidth") === !0 ? !0 : !1), bgcheck = that.data("bgcheck") ? that.data("bgcheck") : !1, loop = that.data("autowidth") === !0 ? !1 : that.data("loop") === !0 ? !0 : !1, duration = 300, thumbs = $("#product-thumbnails");
        ...
        customScroll: {
            ...
            init: function() {
                ...
                container.each(function() {
                    ...
                    win.width() > 767 && base.resize(container);
                });
            },
            resize: function(container) {
