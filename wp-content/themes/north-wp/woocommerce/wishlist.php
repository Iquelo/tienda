...
<section class="extra-page-padding">
<?php } ?>
	                ...
	                foreach( $wishlist as $values ) :   
	                    ...
	                    <tr id="yith-wcwl-row-<?php echo $values['ID'] ?>">
	                        <td class="product-name">
	                        		...
	                        		<?php
	                        			$size = sizeof( get_the_terms( $values['prod_id'], 'product_cat' ) );
	                        			echo $product_obj->get_categories( ', ', '<span class="posted_in">' . _n( '', '', $size,THB_THEME_NAME ) . ' ', '</span>' );
	                        		?>
